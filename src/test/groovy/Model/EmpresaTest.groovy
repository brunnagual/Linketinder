...
class EmpresaTest {
    ...
    void testAdicionarEmpresa() {
        EmpresaModel empresa = new EmpresaModel("Empresa", "joao@example.com", "12345678",
                "12345759000105", "Cadasrtrando empresa");
        ...
        Assertions.assertEquals("Cadasrtrando empresa", empresas.get(0).descricao);
    }
}